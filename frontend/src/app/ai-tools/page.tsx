                                        ...
                                        {activeTool === 'estimator' && (
                                            <div className="space-y-4">
                                                <div className="p-4 bg-[#111111] rounded-xl border border-[#1F1F1F]">
                                                    ...
                                                    <div className="text-3xl font-black text-[#E3000F]">{result.budget || result.data?.estimatedCost || 'Contact us'}</div>
                                                </div>
                                                <div className="p-4 bg-[#111111] rounded-xl border border-[#1F1F1F]">
                                                    <div className="text-xs text-[#888] uppercase tracking-widest mb-1">Timeline</div>
                                                    <div className="text-xl font-bold">{result.timeline || result.data?.estimatedTimeline || 'TBD'}</div>
                                                </div>
                                                <p className="text-sm text-white/50">{result.analysis || result.raw || 'Based on your feature set, we recommend a phased deployment.'}</p>
                                            </div>
                                        )}
                                        ...
                                        {(activeTool === 'analyzer' || activeTool === 'validator') && (
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-xs font-bold text-[#888] uppercase tracking-widest">{activeTool === 'analyzer' ? 'Quality Score' : 'Viability Score'}</span>
                                                    <span className="text-lg font-black text-[#E3000F]">{result.score || result.validation?.viabilityScore || result.analysis?.score || 75}/100</span>
                                                </div>
                                                <div className="h-1.5 w-full bg-[#1F1F1F] rounded-full overflow-hidden">
                                                    <div className="h-full bg-[#E3000F]" style={{ width: `${result.score || result.validation?.viabilityScore || result.analysis?.score || 75}%` }} />
                                                </div>
                                                <div className="p-4 bg-[#111111] border border-[#1F1F1F] rounded-xl">
                                                    ...
                                                    <p className="text-xs text-white/50 leading-relaxed">{result.summary || result.raw || 'Strategic overview generated by AI...'}</p>
                                                </div>
                                            </div>
                                        )}
                                    </div>
